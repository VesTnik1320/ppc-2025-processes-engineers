...
void ZhurinIEdgeSobelMPI::RowDistributionComputing(int world_rank, int world_size, int &base_rows,
...
void ZhurinIEdgeSobelMPI::DataDistribution(int world_rank, const std::vector<int> &send_counts,
